...
========================================================================
                            Please refer to 
   http://www.cc.ntut.edu.tw/~wkchen/game/ for more documents.
========================================================================

一、簡介

game 4.4是一個開發遊戲程式的平台，其目的是作為一個物件導向程式設計教學的
...
game4.4可以用在Windows 98/2000/XP。首先你必須有Visual Studio 2005 C++
或VC++6.0，並先安裝DirectX SDK (8.0以上，版本視complier而定)，電腦配備
則視遊戲的複雜度而定，一般而言，如果不是很複雜的game，Pentium II或
Celeron等級的CPU就足夠了。
...
4. Game 4.1與Game 3.1的差別
   * 內建遊戲狀態性的控制。
   * 可調整的遊戲參數。
   * Complier 與 Direct X之組合
       * VC++6.0 搭配 DirectX 8.x

5. Game 3.1與Game 2.2的差別
   * 支援全螢幕。
   * 支援MIDI。
   * 增加了一個動畫的物件。
   * 修正了一些 bug。